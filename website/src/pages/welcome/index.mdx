...
<section id="intro" class="intro-heading">
	...
	<p class="mb-1">Thank you for installing. We hope you enjoy the extension!</p>
</section>

{/*<!-- Note: if this section is modified, also change it on extension-settings.html -->*/}
...
<section id="pin" class="container mb-4">
	<img class="pin-float d-none d-md-block float-right" src="./pin.png" />
	<h2>Pin the extension</h2>
	<img class="d-block d-md-none w-100 mb-3" src="./pin.png" />
